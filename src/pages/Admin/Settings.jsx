...
const Settings = () => {
  ...
  const fetchCriteria = async () => {
    setLoading(true);
    try {
      // Tải danh mục tiêu chí đánh giá
      ...
      // 🔴 BỔ SUNG BƯỚC 3: Tải cấu hình AI động trực tiếp từ bảng system_settings trong MySQL
  ...
  // 🔴 BỔ SUNG BƯỚC 4: Hàm xử lý đẩy thông số từ thanh trượt lưu vào bảng system_settings
              ...
              <div className="p-4 bg-light bg-opacity-25">
                ...
                <Form>
                  ...
                  <Row className="g-4">
                    ...
                    {/* KHỐI CẤU HÌNH 3: THANH TRƯỢT KIỂM DUYỆT ẢNH BỐI CẢNH */}
                    <Col md={12}>
                  ...
                  <div className="d-flex justify-content-end mt-4 border-top pt-3">
                    {/* ĐÃ THAY ĐÈ: Gọi hàm handleSaveAISettings thực tế để thực thi đồng bộ xuống MySQL */}
                    <Button 
