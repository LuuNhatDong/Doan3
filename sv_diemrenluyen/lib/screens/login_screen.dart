...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    _authSubscription = googleSignIn.onCurrentUserChanged.listen((GoogleSignInAccount? account) async {
      if (account != null && mounted) {
        ...
        try {
          ...
          if (response.data == null) {
            _showSnackBar('⚠️ Server không trả về dữ liệu!');
          ...
          try {
            ...
            _showSnackBar('⚠️ Dữ liệu server trả về không hợp lệ!');
            if (mounted) setState(() => _isConnecting = false);
            return;
          }
          ...
          String errorMessage = 'Kết nối Server thất bại!';
  ...
  // HÀM XỬ LÝ ĐĂNG NHẬP GOOGLE DÙNG CHUNG CHO CẢ WEB & MOBILE
  Future<void> _handleGoogleSignIn() async {
    if (_isConnecting) return;
    setState(() => _isConnecting = true);
    try {
      await googleSignIn.signIn(); // Lệnh này sẽ mở popup trên web một cách an toàn
    } catch (error) {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // NÚT GOOGLE ĐỒNG NHẤT CHO CẢ WEB & MOBILE
                      SizedBox(
                        width: double.infinity,
                        height: 48,
                        child: ElevatedButton.icon(
                          onPressed: _isConnecting ? null : _handleGoogleSignIn,
                          icon: _isConnecting
                          ...
                          label: _isConnecting
                              ...
                              : const Text('Đăng nhập bằng Google', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                          style: ElevatedButton.styleFrom(
